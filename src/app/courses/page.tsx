                    ...
                    <div className="mt-4 p-4 bg-secondary/30 rounded-lg border border-border">
                        ...
                        <div className="flex flex-wrap gap-4 text-sm">
                            <div className="flex items-center gap-2">
                                <span className="px-2 py-1 rounded text-xs bg-red-600 text-white dark:bg-destructive/20 dark:text-destructive font-medium border border-red-600 dark:border-destructive/30">
                                    StEOP Pflicht
                                </span>
                                <span className="text-foreground/70">Muss für StEOP-Abschluss absolviert werden</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="px-2 py-1 rounded text-xs bg-green-600 text-white dark:bg-green-500/20 dark:text-green-400 font-medium border border-green-600 dark:border-green-500/30">
                                    StEOP erlaubt
                                </span>
                                <span className="text-foreground/70">Kann vor StEOP-Abschluss absolviert werden</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="px-2 py-1 rounded text-xs bg-gray-600 text-white dark:bg-muted dark:text-muted-foreground border border-gray-600 dark:border-border">
                                    Nach StEOP
                                </span>
