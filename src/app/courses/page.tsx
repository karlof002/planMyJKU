                    ...
                    <div className="mt-4 p-4 bg-secondary/30 rounded-lg border border-border">
                        ...
                        <div className="flex flex-wrap gap-4 text-sm">
                            <div className="flex items-center gap-2">
                                <span className="px-2 py-1 rounded text-xs bg-red-600 text-white dark:bg-red-800 dark:text-white font-medium border border-red-600 dark:border-red-800">
                                    StEOP Pflicht
                                </span>
                                <span className="text-foreground/70">Muss für StEOP-Abschluss absolviert werden</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="px-2 py-1 rounded text-xs bg-green-600 text-white dark:bg-green-800 dark:text-white font-medium border border-green-600 dark:border-green-800">
                                    StEOP erlaubt
                                </span>
                                <span className="text-foreground/70">Kann vor StEOP-Abschluss absolviert werden</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="px-2 py-1 rounded text-xs bg-gray-600 text-white dark:bg-gray-700 dark:text-white border border-gray-600 dark:border-gray-700">
                                    Nach StEOP
                                </span>
                                ...
                                <div className="flex flex-col gap-2 items-end">
                                    <span
                                        className={`px-3 py-1 rounded-full text-xs font-medium ${course.semester === 'WS'
                                            ? 'bg-indigo-600 text-white dark:bg-indigo-800 dark:text-white border border-indigo-600 dark:border-indigo-800'
                                            : 'bg-amber-600 text-white dark:bg-amber-800 dark:text-white border border-amber-600 dark:border-amber-800'
                                            }`}
                                    >
                                        {course.semester}
                                    </span>
